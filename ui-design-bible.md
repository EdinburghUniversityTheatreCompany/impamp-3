...
- **Interaction:**
  ...
  - Pad name updates automatically to the first added sound's name _only if_ the name was previously "Empty Pad".
...
_(This document will be updated as design decisions are made during development.)_
